...
const TRANSLATIONS = {
  ...
  "home.hartlinkStudioKicker": { zh: "桌面软件 · v0.3.6", en: "Desktop software · v0.3.6" },
  ...
  "home.hartlinkStudioDownload": { zh: "下载 0.3.6", en: "Download 0.3.6" },
  "home.fluentSerialKicker": { zh: "桌面软件 · v0.1.9", en: "Desktop software · v0.1.9" },
  "home.fluentSerialTitle": { zh: "Fluent 串口助手 · 现代串口调试工作台", en: "Fluent Serial Assistant · A modern serial workbench" },
  "home.fluentSerialDesc": { zh: "从基础收发、自动断帧和实时曲线，到协议模板、宏命令、自动应答与 JavaScript 脚本，在一个清爽的多标签桌面工作台里完成串口调试。", en: "Handle everyday I/O, frame splitting and live plots alongside protocol templates, macros, auto replies and JavaScript automation in one clean multi-tab desktop workbench." },
  ...
  "home.fluentSerialPlot": { zh: "实时曲线与数据表格", en: "Live plots and data tables" },
  "home.fluentSerialMore": { zh: "查看软件介绍", en: "Explore Fluent Serial Assistant" },
  "home.fluentSerialDownload": { zh: "下载 0.1.9", en: "Download 0.1.9" },

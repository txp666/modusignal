...
const TRANSLATIONS = {
  ...
  "home.fluentSerialKicker": { zh: "桌面软件 · v0.1.10", en: "Desktop software · v0.1.10" },
  "home.fluentSerialTitle": { zh: "Fluent 串口助手 · 现代串口调试工作台", en: "Fluent Serial Assistant · A modern serial workbench" },
  "home.fluentSerialDesc": { zh: "从基础收发、自动断帧和高性能多通道实时绘图，到协议模板、宏命令、自动应答与 JavaScript 脚本，在一个清爽的多标签桌面工作台里完成串口调试。", en: "Handle everyday I/O, frame splitting and high-performance multi-channel live plotting alongside protocol templates, macros, auto replies and JavaScript automation in one clean multi-tab desktop workbench." },
  "home.fluentSerialTerminal": { zh: "文本 / HEX / 混合终端", en: "Text / HEX / mixed terminal" },
  "home.fluentSerialAutomation": { zh: "宏命令与脚本自动化", en: "Macros and scripting" },
  "home.fluentSerialPlot": { zh: "高性能多通道实时绘图", en: "High-performance multi-channel plotting" },

...
const TRANSLATIONS = {
  ...
  "hart.commDesc": { zh: "支持预设通用命令或自定义命令号 + HEX 数据，帧 XOR 校验自动计算。", en: "Supports preset universal commands or custom command number + HEX data; XOR checksum auto-calculated." },

...
const TRANSLATIONS = {
  ...
  "home.hartlinkStudioDesc": { zh: "连接、设备扫描、实时变量、通信 Trace、仪表设置、校准与 DD 设备管理，一套跨平台桌面软件覆盖完整 HART 调试流程。", en: "Connection, device discovery, live variables, communication traces, instrument settings, calibration and DD management in one cross-platform desktop workflow." },

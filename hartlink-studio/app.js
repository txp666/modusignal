...
const COPY = {
  zh: {
    ...
    pricingPerSeat: "/ 席位",
    pricingProDescription: "永久授权，包含 DD 解析与设备工作区；更新、升级与维护免费。",
  ...
  en: {
    ...
    pricingPerSeat: "/ seat",
    pricingProDescription: "A perpetual license for DD parsing and device workspaces, with free updates, upgrades and maintenance.",
